...
import citizenFoodDropOffBehavior from "./utils/citizenFoodDropOffBehavior";
...
describe("Food pick-up behavior", () => {
  ...
  citizenFoodPickUpBehavior("move", { autoPickUpFood: false });
  citizenFoodPickUpBehavior("pickUpFood");
});

describe("Food drop-off behavior", () => {
  citizenFoodDropOffBehavior("move", { autoDropOffFood: true });
  citizenFoodDropOffBehavior("move", { autoDropOffFood: false });
  citizenFoodDropOffBehavior("dropOffFood");
});
